...
#define TRIO_FEATURE_SIZE_T 0
#define TRIO_FEATURE_QUOTE 0
#define TRIO_FEATURE_FIXED_SIZE 0
#define TRIO_FEATURE_POSITIONAL 0
#define TRIO_FEATURE_USER_DEFINED 0
#define TRIO_FEATURE_ERRNO 0
#define TRIO_FEATURE_STICKY 0
#define TRIO_FEATURE_VARSIZE 0
#define TRIO_FEATURE_ROUNDING 0
